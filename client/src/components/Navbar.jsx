...
const Navbar = () => {
  ...
  <Link to='/' className='flex items-center gap-2'>
    <img src={assets.logo_icon} alt="icon" className="w-6 sm:w-8 lg:w-10 object-contain" />
    <img src={assets.logo} alt="logo" className='w-28 sm:w-32 lg:w-40 object-contain' />
  </Link>
    ...
    <div>
        ...
        <div className='flex items-center gap-2 sm:gap-3'>
            <button onClick={()=>navigate('/buy')} className='flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700'>
                ...
                <p className='text-xs sm:text-sm font-medium text-gray-600'>Pricing</p></button>
