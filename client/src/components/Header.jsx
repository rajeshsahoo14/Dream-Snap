...
<motion.button onClick={onClickHandler} className='inline-flex items-center gap-2 px-12 py-3 mt-5 rounded-full bg-black text-white m-auto hover:scale-105 transition-all duration-500'
...
>Generate Images           
     <img className='h-6' src={assets.star_group} alt="" />
        ...
        className='mt-2 text-neutral-600'>Generated images from DreamSnap</motion.p>
